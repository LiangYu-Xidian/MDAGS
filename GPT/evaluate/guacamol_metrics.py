import sys
sys.path.append('guacamol')
sys.path.append('moses')
sys.path.append('GPT\\train')
import argparse
...
if __name__ == '__main__':
    ...
    gen = gen.sample(n = 1000, random_state = 42).reset_index(drop = True)
    ...
    fcd = FCDMetric(n_jobs = 10, batch_size = 256
                    )(gen=list(gen['smiles'].values), pref=ptest['FCD'])
